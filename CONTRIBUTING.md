```{todo} THIS IS SUPPOSED TO BE AN EXAMPLE. MODIFY IT ACCORDING TO YOUR NEEDS!
   ...
   Please make sure to check the document with these assumptions in mind
...
```{todo} You might want to have a look at [PyScaffold's contributor's guide],

   especially if your project is open source. The text should be very similar to
   this template, but there are a few extra contents that you might decide to
   also include, mentioning labels of your issue tracker or automated
   releases.
```

# Contributing

Welcome to `awk_plus_plus` contributor's guide.

This document focuses on getting any potential contributor familiarized with
the development processes, but [other kinds of contributions] are also appreciated.

If you are new to using [git] or have never collaborated in a project previously,
please look at [contribution-guide.org]. Other resources are also
...
If you experience bugs or general issues with `awk_plus_plus`, please have a look
...
You can help improve `awk_plus_plus` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`awk_plus_plus` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `awk_plus_plus`'s files. While this mechanism can
...
```
conda create -n awk_plus_plus python=3 six virtualenv pytest pytest-cov
conda activate awk_plus_plus
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/awk_plus_plus.git
   cd awk_plus_plus
   ```
...
5. Install [pre-commit]:
   ...
   `awk_plus_plus` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/awk_plus_plus
[issue tracker]: https://github.com/<USERNAME>/awk_plus_plus/issues
